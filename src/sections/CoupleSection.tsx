...
function CoupleSection() {
    return (
      <section className="hello px-4 py-16 flex items-center justify-center bg-no-repeat flex-col bg-cover text-center bg-fixed" style={{
          ...
          <span data-aos="fade-up" className="text-white text-lg italic">The pleasure of your company is requested</span>
          ...
          <h2 data-aos="fade-up" className="text-gold text-2xl mt-4 font-bold primary-font">{data.man_name}</h2>
          ...
          <h2 data-aos="fade-up" className="text-gold text-2xl mt-4 font-bold primary-font">{data.woman_name}</h2>
