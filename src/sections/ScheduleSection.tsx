        ...
        <section className="hello pt-16 flex items-center justify-center bg-no-repeat flex-col bg-contain text-center" style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/images/bg-event.webp)`
                ...
                <div style={{backgroundColor: '#081122'}} className="w-full px-4 pb-16">
                    ...
                    <h1 data-aos="fade-up" className="text-lg text-white mt-4 px-8">Here is to love, and laughter, and happily ever after.</h1>
                    ...
                    <div className="w-full flex flex-col justify-center items-center">
                        ...
                        <h1 data-aos="fade-up" className="text-white text-xl px-8">Jalan Gadihu kediaman bapak Hi. Sunardi Semarang</h1>
                        <h1 data-aos="fade-down" className="text-white text-xl px-8">16:00 WITA</h1>
                    </div>
                    ...
                    <div className="w-full flex flex-col justify-center items-center mt-10">
                        ...
                        <div data-aos="fade-up" className="w-full">
                            <iframe className="w-full rounded-xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3981.5747224583793!2d128.2024163147589!3d-3.683784997319686!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM8KwNDEnMDEuNiJTIDEyOMKwMTInMTYuNiJF!5e0!3m2!1sen!2sid!4v1626461627124!5m2!1sen!2sid" height="400" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
        </section>
