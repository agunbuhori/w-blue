function StorySection() {
    return (
        <div className="px-4 py-8" style={{backgroundColor:'#010a1a'}}>
            <h1 className="text-4xl text-gold text-center primary-font font-bold">Our Story</h1>
            ...
            <div className="text-white mt-10">
                ...
                <p className="text-white text-sm">Tepat di waktu yang tepat pula. Mampu dan bisa sampai pembuktian yang nyata didalam tahap yang lebih untuk bisa berkomitmen aaling menjaga hingga waktunya hari besar nanti tiba. Untuk Kita, Aku, dan Kamu. Akad nikah (23 juli 2021)</p>
